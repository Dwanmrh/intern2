<x-app-layout>
    ...
    <div class="py-10 px-4">
        <div class="max-w-md mx-auto bg-gradient-to-br from-[#2c3e50] to-[#3b4a5a] p-6 rounded-xl shadow-xl border border-white/10 transition-all duration-300">
                ...
                @if($link->logo)
                    <div class="mb-3">
                        ...
                        <img src="{{ asset('storage/' . $link->logo) }}" alt="{{ $link->nama }}"
                             class="h-20 object-contain rounded-md shadow-md">
                    </div>
                @endif
