        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-10 bg-white shadow rounded-lg p-6 flex flex-col md:flex-row items-center md:items-start gap-6">
                <div class="w-full md:w-1/2">
                    <img src="{{ asset('assets/images/setukpa1.jpg') }}" alt="Profil Setukpa"
            ...
            {{-- SECTION 3: Struktur Kepemimpinan --}}
            <div class="mt-12 shadow rounded-lg p-6" style="background-color: rgba(255, 255, 255, 0.40);">
                <div class="relative mb-6">
                    <h2 class="text-2xl font-bold text-[#2c3e50] text-center">Struktur Kepemimpinan</h2>

                    {{-- Tombol Tambah Pimpinan (Hanya untuk admin) --}}
                    @auth
                        @if(Auth::user()->role === 'admin')
                            <a href="{{ route('profil.create') }}"
                                class="absolute right-0 top-1/2 -translate-y-1/2 transform bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm">
                                + Tambah Pimpinan
                            </a>
                        @endif
                    @endauth
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
                    @forelse ($data as $profil)
                        <div class="bg-white shadow-md rounded-lg overflow-hidden flex flex-col w-full">
                            @if ($profil->foto)
                            ...
                            <div class="p-4 flex flex-col justify-between flex-1">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 mb-3 text-center">{{ $profil->jabatan }}</p>
                                </div>
