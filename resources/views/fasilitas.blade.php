    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @foreach($fasilitas as $data)
                <div class="modal fade" id="hapusFasilitasModal{{ $data->id }}" tabindex="-1" aria-labelledby="hapusFasilitasLabel{{ $data->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header bg-danger text-white">
                                <h5 class="modal-title" id="hapusFasilitasLabel{{ $data->id }}">Konfirmasi Hapus</h5>
