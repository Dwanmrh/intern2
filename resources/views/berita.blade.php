            ...
            <div class="relative bg-gray-50 backdrop-blur-md rounded-xl shadow-lg px-6 py-4 mb-8 overflow-hidden">
                ...
                <div class="text-center">
                    <h2 class="text-lg md:text-xl lg:text-xl font-bold text-white inline-flex items-center gap-2
                        ...
                        <i class="bi bi-journal-text text-white text-xl md:text-lg"></i>
                        BERITA
                    </h2>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                    @forelse ($beritas as $berita)
                        <div data-href="{{ route('berita.show', $berita->id) }}"
                             class="card-berita bg-white shadow-md rounded-lg overflow-hidden flex flex-col cursor-pointer hover:scale-105 transition duration-300 ease-in-out relative">
