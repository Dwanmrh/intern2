<x-app-layout>
    ...
    @section('title', 'Fasilitas Khusus | SETUKPA LEMDIKLAT POLRI')
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="shadow rounded-lg p-6 mb-10 relative" style="background-color: rgba(255, 255, 255, 0.40); min-height: 64px;">
                ...
                <div class="relative flex items-center justify-center">
                    <h2 class="text-2xl font-bold text-[#2c3e50]">Fasilitas Khusus</h2>
                </div>
                ...
                @empty
                    <p class="text-gray-600 text-center mt-6">Belum ada fasilitas khusus yang ditambahkan.</p>
                @endforelse
            </div>
        </div>
    </div>
